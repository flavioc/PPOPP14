...
\begin{figure*}[htp]
   \centering
   \resizebox{5cm}{!}{\subfigure[Using a search engine web graph (almost 12000 nodes)]{\includegraphics[width=0.5\textwidth]{speedup_greedy-graph-coloring-search_engines.pdf}}}
   \resizebox{5cm}{!}{\subfigure[Using a weather web graph (around 8000 nodes)]{\includegraphics[width=0.5\textwidth]{speedup_greedy-graph-coloring-weather.pdf}}}
   \resizebox{5cm}{!}{\subfigure[Using a random graph (with 2000 nodes)]{\includegraphics[width=0.5\textwidth]{speedup_greedy-graph-coloring-2000.pdf}}}
...
\begin{figure*}[htp]
   \centering
   \resizebox{5cm}{!}{\subfigure[Using a search engine web graph (almost 12000 nodes)]{\includegraphics[width=0.5\textwidth]{speedup_pagerank-search_engines.pdf}}}
   \resizebox{5cm}{!}{\subfigure[Using a movie web graph (almost 8000 nodes)]{\includegraphics[width=0.5\textwidth]{speedup_pagerank-movies.pdf}}}
   \resizebox{5cm}{!}{\subfigure[Using a random, dense graph (500 nodes)]{\includegraphics[width=0.5\textwidth]{speedup_pagerank-500.pdf}}}
...
While the previous results where computed using only one thread, we also see good speedups with multiple threads. However, the gains reduce as we add
